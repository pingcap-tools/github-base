...
// CommentPatchBase is for common comment including issue comments, reivew comments and reviews
...
// GetCommentByID get comment by unique id
func (mgr *Manager)GetCommentByID(id int64) (*types.Comment, error) {
	var comment types.Comment
	if err := mgr.storage.FindOne(&comment, "comment_id=?", id); err != nil {
...
// MakeComment create from gitpul comment
